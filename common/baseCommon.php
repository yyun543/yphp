...
class baseCommon
{
    ...
    public $commonList = [
        ...
        [
            'name' => 'newcontroller $controllername',
            'desc' => '展示所有可有的脚本',
            'param'=> '控制器名称'
        ],
        [
    ...
    public function showCommon()
    {
        ...
        array_walk($this->commonList, function ($a) {
            echo PHP_EOL;
            echo "\033[37mcommon: \e[31mphp yphp " . $a['name'] . " \e[37m" . 'Desc:' . $a['desc'] ." Param: ".$a['param'] .PHP_EOL;
        });
    }
    ...
    public function welcome()
    {
        $str = "\e[36m====================================================" . "\e[36m" . PHP_EOL
            . "=                    YPHP框架                     =" . PHP_EOL
            . "=                                                  =" . PHP_EOL
            . "=       PHP版本:" . PHP_VERSION . "   框架版本:" . YPHP_VERSION . "            =" . PHP_EOL
            . "====================================================" . PHP_EOL;
        echo $str ;
    }
